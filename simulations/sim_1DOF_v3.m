...
%%% THIS IS A LINEAR ACCELEROMETER SETUP MODEL    %%%
%%% YOU WANT ACCELEROMETER SQUARES JUST WAIT OK   %%%
%%% BOTH MY HOBBY AND MY JOB ARE BOTH MATLAB WHY  %%%
...
HEKF = MeltyBrain_HEKF(dt, alpha, beta, acc_dists, ...
