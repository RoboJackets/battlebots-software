classdef MeltyBrain_EKF < handle
    ...
    methods
        ...
        %}
        function obj = MeltyBrain_EKF(dt, Tsim, alpha, beta, accRad, wheelRad, ...
        imus, mags, maxBField, fieldOffset, beacon, beaconRange)
            ...
            %Define Jacobian
            obj.H = @(theta, omega) [repmat([0 2 * accRad * omega], imus, 1); ...
            ...
            obj.h = @(theta, omega) [repmat([accRad * omega ^ 2], imus, 1); ...
