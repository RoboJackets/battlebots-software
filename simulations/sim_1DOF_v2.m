...
initial_voltage_left = 6; % initial motor voltage (volts fuck u think)
initial_voltage_right = 6;
...
u0 = [initial_voltage_left initial_voltage_right initial_extrestorque initial_extrestorque]; % initial input state
x0 = [initial_position initial_velocity initial_wheel_velocity initial_wheel_velocity]; % initial state space state
...
yy = zeros(steps, 4); % all states (steps -> angular position in rad, 
                      %                         angular velocity in rad/s)
acc_true = zeros(size(acc_pos, 1), steps, 3);                      
acc_data = zeros(size(acc_pos, 1), steps, 3);
yy_all = zeros(numel(tt).*(steps-1), 4); % yy but with like wayyy more                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                  l = zeros(numel(tt).*(steps-1), 2); % yy but with like wayyy more
uu(1, :) = u0;
yy(1, :) = x0;
...
for k=2:steps
    ...
    % Update the physics 
    if k==2
        [yy(k, :), yy_all_temp] = step1PlaneSVM(sysd, A, B, ...
            yy(k-1, :), uu(k-1, :), ...
            dt, Ts, slew_rate);
    else
        [yy(k, :), yy_all_temp] = step1PlaneSVM(sysd, A, B, ...
